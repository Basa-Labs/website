...
class WPSC_Shortcodes {
            ...
            if ( $code == $code_input) {
                ...
                return $m->render(
                    ...
                    [
                        ...
                        'msg' => "Your activation was successful, thanks for confirming, now you can go back to the page and log in"
                    ]
                );
                ...
                return $m->render(
                        ...
                        [
                            ...
                            'msg' => "User activation failed, was it already activated?"
                        ]
                );
            }
        } else {
    ...
    public function wizard($params) {
        ...
        $atts["choose-flavor-title"] = __("Choose the flavor of the Smart Contract that better suit your needs", "wp-smart-contracts");
    ...
    public function nftTaxonomy($params) {
        ...
        if ($params["taxonomy"]=="nft-gallery" and $collection_id) {	
            if (!get_post_meta($collection_id, 'wpsc_sub_collections', true)) {	
                return $m->render(WPSC_Mustache::getTemplate('wpsc-message'), ["error"=>true, "title"=>"An error has ocurred", "message"=>"Galleries are not enabled in this collection"]);	
            }	
        }
        ...
        if (WPSC_helpers::valArrElement($the_params, "wpsc-erc-1155")) {
            ...
            if (!$nft_moralis_key) {
                ...
                <div class="ui warning message">
                    ...
                    <p>You must configure the Moralis API key for the ERC-1155 token UI to work properly</p>
                    <p>Go to "Settings" &raquo; "WP Smart Contracts" and follow the instructions in the Moralis API Section</p>
                </div>
WARNING;
            }
        }
        ...
        if ($gallery_id and !has_term($gallery_id, "nft-gallery", $the_id)) {	
            $the_params["message"] = $m->render(WPSC_Mustache::getTemplate('wpsc-message'), [	
                ...
                "title"=>"", 	
                "extra" => "mini compact",	
                "message"=>"You are viewing an item outside the selected gallery"	
            ]);	
        }	
